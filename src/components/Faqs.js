        ...
        <Container className="faqs-container">
            <Row className="faqs-row">
                <Col xs={12} className="faqs-col">
                    <h3 className="h3 faqs-title">FAQs About Blessed Pomade</h3>
                </Col>
                <Col xs={12} className="faq-item">
                    <h4 className="faq-question">What is water-based pomade?</h4>
                ...
                <Col xs={12} className="faq-item">
                    <h4 className="faq-question">How does Blessed Pomade differ from oil-based pomades?</h4>
                    <p className="faq-answer">
                ...
                <Col xs={12} className="faq-item">
                    <h4 className="faq-question">Can I use water-based pomade on all hair types?</h4>
                    <p className="faq-answer">
                ...
                <Col xs={12} className="faq-item">
                    <h4 className="faq-question">Is Blessed Pomade safe for dyed or treated hair?</h4>
                    <p className="faq-answer">
                ...
                <Col xs={12} className="faq-item">
                    <h4 className="faq-question">How long does the hold last with Blessed Pomade?</h4>
                    <p className="faq-answer">
